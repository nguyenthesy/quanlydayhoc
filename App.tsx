...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const loadedConfigs = getClassConfigs();
        setStudents(loadedStudents);
        setConfigs(loadedConfigs);

        // Load saved theme if any (mock implementation using local storage)
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (username === "admin" && password === "abcd@123") {
            ...
            setView(ViewState.DASHBOARD);
        } else if (username === "bichha" && password === "290578") {
            setCurrentUser("GV: Nguyễn Thị Bích Hà");
            setView(ViewState.DASHBOARD);
        } else {
                ...
                <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 animate-in fade-in zoom-in-95 duration-300">
                    <div className="bg-primary-600 p-8 text-center transition-colors duration-500">
                        ...
                        <p className="text-primary-100 text-sm mt-2">
                            Hệ thống quản lý dạy và học thêm
                        </p>
                    </div>
                    <div className="p-8">
